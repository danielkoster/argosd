"""Run PEP8 on all Python files in this directory
    and subdirectories as part of the tests.
    Source: https://gist.github.com/swenson/8142788"""
...
ignore_patterns = ('.git', '.virtualenv')
...
class TestPep8(unittest.TestCase):
    ...
    def test_pep8(self):
        ...
        for root, _, files in os.walk('.'):
            ...
            python_files = [os.path.join(root, f) for
                            f in files if f.endswith('.py')]
